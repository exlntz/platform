...
SUBJECT_TO_TAGS = {
    ...
    Subject.ALGORITHMS: [Tag.INFORMATICS_TAG,Tag.SEQUENCES, Tag.SORTING, Tag.GRAPHS, Tag.RECURSION, Tag.SEARCH, Tag.DATA_STRUCTURES, Tag.OPTIMIZATION, Tag.LOGARITHMS, Tag.MEMORY, Tag.TERMINOLOGY, Tag.BIG_O, Tag.ALGORITHMS_TAG],
