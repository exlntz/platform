...
SUBJECT_TO_TAGS = {
    ...
    Subject.GEOMETRY: [Tag.GEOMETRY_TAG, Tag.ANGLES, Tag.SHAPES, Tag.MATH_TAG],
    ...
    Subject.INFORMATICS: [Tag.BASICS, Tag.NUMBER_SYSTEMS, Tag.TERMINOLOGY, Tag.MEMORY, Tag.BOOLEAN_ALGEBRA, Tag.NETWORKS, Tag.PROTOCOLS, Tag.STORAGE, Tag.UNITS, Tag.LOGIC_TAG, Tag.DB_SHORT, Tag.DESIGN, Tag.NUM_SYSTEMS, Tag.PC, Tag.BYTES, Tag.WINDOWS, Tag.FILES, Tag.SOFT, Tag.INTERNET, Tag.IT],
    ...
    Subject.QUANTUM_PHYSICS: [Tag.QUANTA, Tag.INFORMATICS],
    ...
    Subject.NETWORKS_SUBJ: [Tag.NETWORK_TAG, Tag.INFORMATICS],
